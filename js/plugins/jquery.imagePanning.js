(function($){
	$.fn.destroyImagePanning=function(){
		return this.each(function(){
			var $this=$(this);
			$this.parent().unbind("mousemove touchmove MSPointerMove pointermove");
			$this.removeClass("loaded");
			$this.closest("div.resize").remove();
			$this.attr("style", "");
			$this.unwrap("div.img-pan-container");
		});
	}
	$.fn.imagePanning=function(){
		...
		return this.each(function(){
			...
			$this.data("imagePanning",1)
				...
				//panning fn
				.parent().bind("mousemove touchmove MSPointerMove pointermove",function(e,p){
					var cont=$(this);
					e.preventDefault();
